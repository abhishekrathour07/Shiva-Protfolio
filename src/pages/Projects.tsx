  ...
  const projects = [
    {
      ...
      description: "Developed comprehensive market entry strategy for a retail chain expanding into Southeast Asian markets.",
    ...
    },
    {
      ...
      description: "Led a team project to optimize supply chain operations for a manufacturing company, resulting in 20% cost reduction.",
    ...
    },
    {
      ...
      description: "Designed and implemented digital transformation strategy for a traditional retail business.",
